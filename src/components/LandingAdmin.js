...
export default function ExampleLandingAdmin() {
  return (
    <div className="relative bg-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Capstone Project</span>{' '}
                <span className="block text-yellow-500 xl:inline">Team Bravo</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-3 mt-5">
        <img
          className="mx-auto h-56 object-cover sm:h-72 md:h-96 lg:m-14 lg:justify-center"
          src={logo}
          alt="logo"
        />
      </div>
